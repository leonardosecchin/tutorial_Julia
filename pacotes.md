...
- [`QuadraticModels.jl`](https://github.com/JuliaSmoothOptimizers/QuadraticModels.jl). Escrita de modelos de otimização quadráticos no formato
...
- [`HiGHS.jl`](https://github.com/jump-dev/HiGHS.jl). Interface para [HiGHS](https://highs.dev/), um *solver* livre para programação linear inteira mista e programação quadrática.
- [`SCIP.jl`](https://github.com/scipopt/SCIP.jl). Interface para [SCIP](https://scipopt.org/), um *solver* livre para programação linear inteira mista.
- [`LBFGSB.jl`](https://github.com/Gnimuc/LBFGSB.jl). Interface para [L-BFGS-B](https://users.iems.northwestern.edu/%7Enocedal/lbfgsb.html), um *solver* eficiente escrito em Fortran para minimização de funções gerais com muitas variáveis contendo limitantes.
